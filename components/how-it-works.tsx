...
export default function HowItWorks04Kelo({
  ...
  return (
    <section
      className={
        "w-full py-[140px] px-5 md:px-20 overflow-hidden " + (className || "")
      }
    >
      <div className="max-w-[1200px] mx-auto">
        ...
        >
          ...
          <p className="text-[15px] text-[#888] leading-[1.6] max-w-[380px] mx-auto">
            Brief, design, build, launch — one studio from the first note to a
            live product.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {steps.map((item, index) => (
            <motion.div
              ...
              className="relative bg-[#EDE7DB] rounded-[32px] p-10 flex flex-col items-start min-h-[280px] transition-colors hover:bg-[#fff] cursor-pointer group"
            >
