        ...
        {VISIBLE_OFFSETS.map((offset) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                "rounded-[28px] sm:rounded-[32px] bg-white text-black shadow-[0_10px_30px_rgba(95,109,119,0.08),0_4px_12px_rgba(95,109,119,0.06)] dark:shadow-[0_10px_30px_rgba(0,0,0,0.6),0_4px_12px_rgba(0,0,0,0.4)] overflow-visible",
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected
                  ? "w-[80px] bg-white"
                  : "w-[8px] bg-white hover:bg-white/30",
              )}
            >
              {isSelected && (
                <div
