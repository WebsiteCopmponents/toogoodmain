...
const CALL_HREF = "tel:+447000000000";
const WHATSAPP_HREF =
...
function ProjectForm({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="grid min-h-0 flex-1 grid-cols-1 overflow-hidden md:grid-cols-[0.88fr_1.12fr]">
      <aside className="flex flex-col gap-4 bg-[#f6f6f7] p-5 sm:p-6 md:p-7">
        ...
        <div className="grid grid-cols-2 gap-3">
          <a
            href={CALL_HREF}
            className="flex items-center justify-center gap-2 rounded-full bg-white px-4 py-3.5 text-[14px] font-medium text-black transition-colors hover:bg-[#034F47] hover:text-white"
          >
            <Phone size={16} />
            Call
          </a>
